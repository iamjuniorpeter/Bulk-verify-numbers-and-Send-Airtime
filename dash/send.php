            ...
            try {
                ...
                if($results['status'] == 'success'){
                    ...
                    if(!isset($results['data']->errorMessage)){
                        ...
                        $db->saveErrorLog($phone_number[$i]['phone_number'], $results['data']->errorMessage, 'AfricaStalking');
                    }                 
                }else{
                    $sms_sent = 0;
                    $attempt = 1;
                ...
                $db->saveErrorLog($phone_number[$i]['phone_number'], $e->getMessage(), 'AfricaStalking');
            }
